    ...
    <div className="App">
      <div className='flex  px-5 mt-10'>
        ...
        <div className='w-1/3 border-2 mr-2 px-5'>
          ...
          <input className='w-full border-2 mb-5' type="text" placeholder='Todo description' /><br />
          ...
          <input className='w-full border-2 mb-5' type="text" placeholder='Completion date' /> <br />
        ...
        <div className='border-2 w-full pl-5'>
          <h1 className='font-bold text-3xl mb-5 underline underline-offset-8 mt-5'>Terrakodo Todo List</h1>
          <ul>
            <li className='text-left text-lg border-2 border-black p-2 mr-5 mb-2'>
              <div className="flex">
                <div>List <span className={`text-pink-700 font-bold ${!editStatus ? "inline" : "hidden"} `}>Medium</span></div>
